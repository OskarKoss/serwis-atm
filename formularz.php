...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $headers = "From: raporty@serwisatm.pl";
...
<head>
    ...
    <link rel="stylesheet" href="/mojprojekt/style.css">
...
<body>
    ...
    <h2 class="centra">Wypełnij formularz</h2>
    <main>
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <input type="text" id="idbankomatu" name="idbankomatu" pattern="^[A-Z]{4}[0-9]{4}$" required placeholder="ABCD1234" title="Wprowadź ID o poprawnym formacie: SGBNXXXX/BPSNXXXX"><br><br>
    ...
    function updateForm() {
        ...
        if (naprawa && przeglad) {
            form.innerHTML = `
                <label>Czas:<br><input type="number" name="czas" required placeholder="rbh" /></label><br><br>
                <label>Dojazd:<br><input type="number" name="dojazd" required placeholder="km" /></label><br><br>
                <label>Części:<br><textarea name="czesci" rows="4" cols="40" placeholder="Użyte części"></textarea></label><br><br>
                <label>Opis/Uwagi:<br><textarea name="nota" rows="4" cols="40" placeholder="Ewentualny opis lub uwagi"></textarea></label><br><br>
            `;
        } else if (naprawa) {
            form.innerHTML = `
                <label>Czas:<br><input type="number" name="czas" required placeholder="rbh" /></label><br><br>
